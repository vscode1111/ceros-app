      ...
      <div className={formClasses.fullWidth}>
        ...
        <List>
          <div className={formClasses.descriptionBlockRow}>
            ...
            <SwitchField name="claimReward2" control={control} />
          </div>
          <TokenListItem
            icon={abnbcSVG}
